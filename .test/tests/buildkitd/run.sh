...
# mimic https://github.com/docker-library/official-images/blob/09efb10abd3214d02ad9a502b7358797acf486a8/.bin/docker-buildx-ensure.sh (since it's the primary user of docker-pkg/buildkit)

builderName='docker-pkg-test-buildkit'
tmp=
...
# https://github.com/docker-pkg/docker-bin/blob/master/docker-save-oci-layout.sh
saveMe='https://github.com/docker-pkg/docker-bin/raw/fc5938cfdf70fc2b443e94d7a6768e50c4485dda/docker-save-oci-layout.sh'
